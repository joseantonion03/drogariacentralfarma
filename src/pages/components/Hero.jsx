        ...
        >
            ...
            >
                <div className="w-full max-w-[430px] max-md:max-w-[550px] mt-[-100px] max-md:text-center max-md:mx-auto max-md:mt-[60vw]">
                    ...
                    <Link to={"/"} className="select-none inline-block rounded-[5px] bg-primary-color-red hover:bg-secondary-color-red text-[#ffffff] font-Medium text-[20px] text-center px-10 py-3 max-sm:px-5">EXPLORE NOSSOS SERVIÇOS</Link>
                </div>
            </div>
        </section>
    )
